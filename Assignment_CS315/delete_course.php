					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Delete Course <i class="icon-trash"></i></h3>
							</div>
									...
									<div class="module-body">
										...
										<?
											$row=$rows->fetch(PDO::FETCH_OBJ)
												...
												?>
												<input type="hidden" name="C_nu" value="<? echo $row->C_no ?>">
												<label class="radio">
													<tr>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" name="submitD" class="btn btn-primary pull-right"> Delete <i class="icon-trash"></i></button>
											</div>
										</div>
									</form>
									</div>
...
function delete_($conn)
{
	...
	try
	{
		...
		$sql="DELETE FROM Course WHERE C_no='$C_nu'";
        if($conn->exec($sql))
		{
			echo "<h3>Has Deletion <i class='icon-ok'></i></h3>";
		}
