...
function Form($conn)
{
	$rows=$conn->query("SELECT C_no FROM Course");
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Update Course <i class="icon-refresh"></i></h3>
							</div>
...
{
	extract($_POST);
	$rows=$conn->query("SELECT * FROM Course WHERE C_no='$C_no'");
	$row=$rows->fetch(PDO::FETCH_OBJ);
	$row2=$conn->query("SELECT * FROM Course WHERE C_no='$C_no'");
								...
								<h3>Update Course <i class="icon-refresh"></i></h3>
									...
									<form class="form-horizontal row-fluid" action="" method="post" onsubmit="return valid();">
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="co" name="C_no" value="<? echo $row->C_no; ?>" class="span8">
									...
									<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="cname" name="C_name" value="<? echo $row->C_name; ?>" class="span8">
										...
										<div class="control-group">
											<label class="control-label">Credits : </label><br>
											<div class="controls">
													...
													<? if($row->Credits=="1")
													{
														?>
														<label class="radio">
														<input type="radio" name="Credits" value="1" checked>1
														</label>
														<label class="radio">
														...
														<label class="radio">
														<input type="radio" name="Credits" value="4">4
														</label>
													...
													if($row->Credits=="2")
													{
														...
														<label class="radio">
														<input type="radio" name="Credits" value="2" checked>2
														</label>
														<label class="radio">
														<input type="radio" name="Credits" value="3">3
														</label>
														...
														if($row->Credits=="3")
													{
														...
														<label class="radio">
														<input type="radio" name="Credits" value="3"checked>3
														</label>
														<label class="radio">
														<input type="radio" name="Credits" value="4">4
														</label>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" id="ln" name="L_no" value="<? echo $row->L_no; ?>" class="span8">
...
function update($conn)
{
	...
	try
	{
		...
		$sql="UPDATE Course SET  C_no='$C_no',C_name='$C_name',Credits='$Credits',L_no='$L_no' WHERE C_no='$C_no' ";
        $conn->exec($sql);
