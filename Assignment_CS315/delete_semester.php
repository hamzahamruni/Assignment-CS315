							...
							<div class="module-head">
								<h3>Delete Semester</h3>
									...
									<form class="form-horizontal row-fluid" action="" method="post">
											...
											<input type="hidden" name="S_noo" value="<? echo $row->S_no; ?>" >
											
										<br>	
										<div class="control-group">
										
											<div class="controls">
												Semester Number : <? echo $row->S_no ?>
										...
										<div class="control-group">
											...
											<div class="controls">
												Start Date : <? echo $row->Start_date; ?>
										...
										<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit_D" class="btn btn-primary pull-right"> Delete <i class="icon-trash"></i></button>
											</div>
										</div>
									</form>
							</div>
...
function delete_($conn)
{
	...
	try
	{
		...
		$sql="DELETE FROM semester WHERE S_no='$S_noo' ";
        if($conn->exec($sql))
		{
