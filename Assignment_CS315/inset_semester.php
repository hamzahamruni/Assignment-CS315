								...
								<h3>Added New Semester</h3>
									...
									<form class="form-horizontal row-fluid" action="" method="post">
										<div class="control-group">
											...
											<div class="controls">
												<input type="date" id="basicinput" name="Start_date" class="span8">
									...
									<div class="control-group">
											...
											<div class="controls">
												<input type="date" id="basicinput" name="End_date" class="span8">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<label class="radio">
													<input type="radio" name="Sem" value="Autumn">
													Autumn
												</label> 
...
function insert($conn)
{
	...
	try
	{
		...
		extract($_POST);
		$sql="INSERT INTO semester (Start_date,End_date,Sem) VALUES ('$Start_date','$End_date','$Sem')";
        if($conn->exec($sql))
		{
			echo "<h3>Has Added Of New Semester <i class='icon-ok'></i></h3>";
		}
